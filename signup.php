...
<div class="max-width-1 margin-auto">
            <div class="contact font3">
                <h2>Feel Free To Sign Up</h2>
                <div class="contactForm">
                    <form action="/21/handlesignup.php" method="post">
                    <div class="formBox" id="email">
                        <label for="exampleInputEmail1" class="form-label">Email</label>
                        <input type="email" class="form-control" id="signupemail" name="signupemail" aria-describedby="emailHelp" placeholder="Enter Your Email">
                    </div>
